...
func TestNew_CreatesHandler(t *testing.T) {
	...
	// Act
	handler := handlers.New(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, encoder, responseHandler)
...
func TestEncodeID_Success(t *testing.T) {
	// Arrange
	encoder := createTestEncoder()
	handler := handlers.New(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, encoder, nil)
