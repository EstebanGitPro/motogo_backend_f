...
func TestGetMotorcycle_Integration_Success(t *testing.T) {
	...
	motorcycleInteractor := interactor.NewMotorcycleInteractor(mockService)
	...
	mockService.On("GetMotorcycleByID", mock.Anything, testMotorcycle.ID).Return(testMotorcycle, nil)
...
func TestListMotorcycles_Integration_Success(t *testing.T) {
	...
	mockService.On("GetMotorcyclesByOwner", mock.Anything, testPersonMoto.ID).Return(motorcycles, nil)
...
func TestUpdateMotorcycle_Integration_Success(t *testing.T) {
	...
	mockService.On("ValidateMotorcycleOwnership", mock.Anything, testMotorcycle.ID, testPersonMoto.ID).Return(testMotorcycle, nil)
	mockService.On("ApplyMotorcycleUpdates", mock.Anything, testMotorcycle, mock.AnythingOfType("*domain.Motorcycle")).Return(nil)
	mockService.On("BeginTx", mock.Anything).Return(mockTx, nil)
	mockService.On("UpdateMotorcycle", mock.Anything, mockTx, testMotorcycle).Return(nil)
	mockTx.On("Commit").Return(nil)
	mockService.On("GetMotorcycleByID", mock.Anything, testMotorcycle.ID).Return(updatedMoto, nil)
...
func TestDeleteMotorcycle_Integration_Success(t *testing.T) {
	...
	mockService.On("ValidateMotorcycleOwnership", mock.Anything, testMotorcycle.ID, testPersonMoto.ID).Return(testMotorcycle, nil)
	mockService.On("CheckServiceHistory", mock.Anything, testMotorcycle.ID).Return(false, nil)
	mockService.On("BeginTx", mock.Anything).Return(mockTx, nil)
	mockService.On("DeleteMotorcycle", mock.Anything, mockTx, testMotorcycle.ID, false).Return(nil)
	mockTx.On("Commit").Return(nil)
...
func TestGetBrandLines_Integration_Success(t *testing.T) {
	...
	mockService.On("GetReferencesByBrandID", mock.Anything, brandID).Return(refs, nil)
