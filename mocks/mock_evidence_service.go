...
// MockEvidenceService is a mock implementation of input.EvidenceService
...
func (m *MockEvidenceService) ValidateMotorcycleOwnership(ctx context.Context, motorcycleID, ownerID string) (*domain.Motorcycle, error) {
...
func (m *MockEvidenceService) GetByID(ctx context.Context, evidenceID string) (*domain.MotorcycleEvidence, error) {
...
func (m *MockEvidenceService) GetByMotorcycleID(ctx context.Context, motorcycleID string) ([]domain.MotorcycleEvidence, error) {
	args := m.Called(ctx, motorcycleID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockEvidenceService) ApplyUpdatesAndCleanup(ctx context.Context, existing *domain.MotorcycleEvidence, updates *domain.MotorcycleEvidence) {
