// Package jwt provides JWT token parsing utilities for Keycloak action tokens.
// This package handles the extraction of claims from Keycloak-issued JWTs
// without performing cryptographic validation (validation is done by Keycloak).
package jwt
