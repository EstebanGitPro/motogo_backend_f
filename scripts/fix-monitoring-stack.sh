...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}  Reparación del Stack de Monitoreo Motogo${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
check_network() {
    ...
    if [[ "$network_info" == *"motogo-network"* ]]; then
        echo -e "  ${GREEN}✅ $container → conectado a motogo-network${NC}"
        return 0
    else
...
check_network "motogo-prometheus" || all_ok=false
check_network "motogo-grafana" || all_ok=false
check_network "motogo-loki" || all_ok=false
check_network "motogo-promtail" || all_ok=false
...
if [ "$all_ok" = true ]; then
    ...
    echo -e "  docker logs motogo-prometheus"
    echo -e "  docker logs motogo-loki"
    echo -e "  docker logs motogo-promtail"
fi
